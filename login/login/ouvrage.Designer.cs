...
namespace login
{
	partial class ouvrage
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Ajout d\'un ouvrage";
			// 
			// label3
			// 
			...
			this.label4.Text = "Année d\'édition";
			// 
			// textBox1
			// 
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(285, 148);
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(377, 207);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(75, 23);
			this.button5.TabIndex = 11;
			this.button5.Text = "supprime";
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.Button5Click);
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(498, 96);
